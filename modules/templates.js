    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-3xl flex flex-col max-h-full overflow-hidden">
        ...
        <div class="p-6 overflow-y-auto modal-scroll bg-white flex-1">
            <div id="sync-step-1" class="text-center py-6">
                ...
                <h3 class="text-lg font-medium text-gray-800 mb-2">Zoek naar nieuwe contacten</h3>
                <p class="text-sm text-gray-500 mb-6 max-w-md mx-auto">De app kijkt in jouw adresboek (Google Contacts) en vergelijkt dit met de huidige database. We laten je zien wie er nieuw is, en jij bepaalt wie er geïmporteerd wordt.</p>
            ...
            <div id="sync-step-2" class="hidden">
                <h3 class="text-sm font-semibold text-gray-800 mb-3 flex items-center justify-between">
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <table class="w-full text-left">
                        ...
                        <tbody id="sync-contacts-body" class="text-sm divide-y divide-gray-100"></tbody>
                    </table>
                </div>
            </div>
        </div>
        <div id="sync-modal-footer" class="hidden px-6 py-4 border-t border-gray-100 bg-gray-50/50 flex justify-end gap-3 rounded-b-2xl">
            <button data-close="sync-modal" class="px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-200 rounded-lg transition-colors mr-auto">Annuleren</button>
...
<div id="mailing-modal" class="hidden fixed inset-0 bg-gray-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-3xl flex flex-col max-h-full overflow-hidden">
        ...
        <div class="p-6 overflow-y-auto modal-scroll bg-white flex-1">
            <div class="mb-5 bg-blue-50 border border-blue-100 rounded-lg p-4 flex gap-3">
                <i data-lucide="info" class="w-5 h-5 text-apple-blue shrink-0 mt-0.5"></i>
                <div>
                    <p class="text-sm text-gray-700 font-medium">Je gaat e-mailen naar je huidige gefilterde lijst.</p>
                    <p class="text-xs text-gray-500 mt-1">Geldige ontvangers: <strong id="mailing-count" class="text-apple-blue">0</strong> artiesten.<br>Mensen zonder e-mailadres, unsubscribes en blacklists worden automatisch overgeslagen door het systeem.</p>
                </div>
            </div>
            <div class="space-y-4">
                <div><label class="block text-xs text-gray-500 mb-1 font-semibold">Onderwerp</label><input type="text" id="mailing-subject" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-apple-blue/50" placeholder="Bijv: Haagse Open Mic op dinsdag a.s. in Amare!"></div>
                <div><label class="block text-xs text-gray-500 mb-1 font-semibold flex justify-between"><span>Jouw Bericht</span><span class="text-gray-400 font-normal">Aanhef ("Hoi [Naam],") wordt automatisch toegevoegd!</span></label><textarea id="mailing-body" rows="8" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-apple-blue/50 placeholder-gray-400" placeholder="Typ hier het bericht dat je aan iedereen wilt sturen..."></textarea></div>
            </div>
        </div>
        <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/50 flex justify-end gap-3 rounded-b-2xl">
            <button data-close="mailing-modal" class="px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-200 rounded-lg transition-colors mr-auto">Annuleren</button>
