...
export function renderTable(dataToRender, elements) {
    ...
    sortedData.forEach(artist => {
        ...
        let typeSelect = `<select data-field="Soort contact" data-row="${artist.rowIndex}" onchange="window.updateArtistField(event)" class="bg-transparent font-medium text-gray-900 dark:text-gray-100 text-sm outline-none cursor-pointer focus:ring-1 focus:ring-apple-blue rounded hover:bg-gray-100 dark:hover:bg-gray-700 py-0 px-1 -ml-1 transition-colors">
