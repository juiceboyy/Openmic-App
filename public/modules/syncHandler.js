...
export function renderSyncContacts(contacts, elements) {
    ...
    contacts.forEach((contact, index) => {
        ...
        let contactStr = '';
        if(contact.email) contactStr += `<div><i data-lucide="mail" class="w-3.5 h-3.5 inline mr-1 text-gray-400"></i> <a href="mailto:${contact.email}" class="hover:underline text-apple-blue">${contact.email}</a></div>`;
