...
export const createLineupItemHTML = (i, artist, num) => `
    <div draggable="true" ondragstart="handleDragStart(event, ${i}, 'main')" ondragover="handleDragOver(event)" ondragenter="handleDragEnter(event)" ondragleave="handleDragLeave(event)" ondrop="handleDropOnMain(event, ${i})" ondragend="handleDragEnd(event)" class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700 group transition-all hover:border-apple-blue/30 cursor-move">
...
export const createReserveItemHTML = (i, artist) => `<div draggable="true" ondragstart="handleDragStart(event, ${i}, 'reserve')" ondragend="handleDragEnd(event)" class="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border border-orange-100 dark:border-orange-900/30 shadow-sm cursor-move hover:border-orange-300 transition-colors"><i data-lucide="grip-vertical" class="w-4 h-4 text-gray-300 cursor-grab mr-1"></i><div class="flex-1 font-medium text-gray-900 dark:text-gray-100">${getDisplayName(artist)}</div><button onclick="removeArtistFromReserve(${i})" class="p-1.5 text-red-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-md transition-colors"><i data-lucide="x" class="w-4 h-4"></i></button></div>`;